...
folder = "D:/python_code/Single-Underwater-Image-Enhancement-and-Color-Restoration-master/Underwater Image Color Restoration/NewOpticalModel"
...
for i in range(len(files)):
    ...
    if os.path.isfile(filepath):
        ...
        cv2.imwrite(folder+'/OutputImages/' + prefix + '_NewOpticalModel_TM.jpg', np.uint8(transmissionR * 255))
        # cv2.imwrite('OutputImages/' + prefix + '_NewOpticalModel_TM_GB.jpg', np.uint8(transmissionGB * 255))
        cv2.imwrite(folder+'/OutputImages/' + prefix + '_NewOpticalModel.jpg', sceneRadiance)
