...
folder = r"D:\python_code\Single-Underwater-Image-Enhancement-and-Color-Restoration-master\Underwater Image Color Restoration\UDCP"
...
for i in range(len(files)):
    ...
    if os.path.isfile(filepath):
        ...
        cv2.imwrite('Underwater Image Color Restoration\\UDCP\\OutputImages\\' + prefix + '.jpg', sceneRadiance)
