...
folder = "D:/python_code/Single-Underwater-Image-Enhancement-and-Color-Restoration-master/Underwater Image Color Restoration/GBdehazingRCorrection"
...
for i in range(len(files)):
    ...
    if os.path.isfile(filepath):
        ...
        cv2.imwrite(folder+'/OutputImages/' + prefix + '_GBDehazedRcoorectionUDCP_TM.jpg', np.uint8(transmission[:, :, 0] * 255))
        ...
        # print('sceneRadiance',sceneRadiance)
        cv2.imwrite(folder+'/OutputImages/' + prefix + 'GBDehazedRcoorectionUDCPAdaptiveMap.jpg', sceneRadiance)
