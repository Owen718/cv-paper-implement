...
folder = "D:/python_code/Single-Underwater-Image-Enhancement-and-Color-Restoration-master/Underwater Image Color Restoration/DCP"
...
for i in range(len(files)):
    ...
    if os.path.isfile(filepath):
        ...
        cv2.imwrite( prefix + '_DCP_TM.jpg', np.uint8(transmission * 255))
        cv2.imwrite( prefix + '_DCP.jpg', sceneRadiance)
